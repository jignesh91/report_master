                    ...
                    <div class="table">
                        ...
                        <table class="table table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {!! Form::select('month',[''=>'Select Month']+$months,$month,['class' => 'form-control', 'data-required' => true,'id'=>'month_id']) !!}
                                    </td>
                                    <td>
                                        {!! Form::select('year',[''=>'Select year']+$years,$year,['class' => 'form-control', 'data-required' => true,'id'=>'year_id']) !!}
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="4"> </td>
                                ...
                                <tr>
                                    ...
                                    <td> Leave Taken </td>
                                    <td> {!! Form::text('leave_taken',null,['class' => 'form-control', 'data-required' => true,'placeholder' => 'Leave Taken','id'=>'leave_taken']) !!} </td>
                                </tr>
                                <tr>
                                    <td> PAN No. </td>
                                ...
                                <tr>
                                    <td> Basic Salary</td>
                                    <td> {!! Form::text('basic_salary','0',['class' => 'form-control', 'data-required' => true,'id'=>'basic_salary']) !!} </td>
                                    <td> Advance</td>
                                    <td>  {!! Form::text('advance',0,['class' => 'form-control', 'data-required' => true,'id'=>'advance']) !!}</td>
                                </tr>
                                <tr>
                                    <td> HRA</td>
                                    <td> {!! Form::text('hra','0',['class' => 'form-control', 'data-required' => true,'id'=>'hra']) !!} </td>
                                    <td> Leave Deduction</td>
                                    <td>  {!! Form::text('leave_deduction',0,['class' => 'form-control', 'data-required' => true,'id'=>'leave_deduction']) !!}</td>
                                </tr>
                                <tr>
                                    <td> Conveyance Allowance</td>
                                    <td> {!! Form::text('conveyance_allowance','1600',['class' => 'form-control', 'data-required' => true,'id'=>'conveyance_allow']) !!} </td>
                                    <td> Other Deduction</td>
                                    <td>  {!! Form::text('other_deduction',0,['class' => 'form-control', 'data-required' => true,'id'=>'other_deduction']) !!}</td>
                                </tr><tr>
                                    <td> Telephone Allowance</td>
                                    <td> {!! Form::text('telephone_allowance','1250',['class' => 'form-control', 'data-required' => true,'id'=>'telephone_allow']) !!} </td>
                                    <td> TDS</td>
                                    <td>  {!! Form::text('tds',0,['class' => 'form-control', 'data-required' => true,'id'=>'tds']) !!}</td>
                                </tr><tr>
                                    <td> Medical Allowance</td>
                                    <td> {!! Form::text('medical_allowance','1250',['class' => 'form-control', 'data-required' => true,'id'=>'medical_allow']) !!} </td>
                                    <td> </td>
                                    <td>  </td>
                                </tr><tr>
                                    <td> Uniform Allowance</td>
                                    <td> {!! Form::text('uniform_allowance','1250',['class' => 'form-control', 'data-required' => true,'id'=>'uniform_allow']) !!}</td>
                                    <td> </td>
                                    <td> </td>
                                </tr>
                                <tr>
                                    <td> Special Allowance</td>
                                    <td> {!! Form::text('special_allowance','1650',['class' => 'form-control', 'data-required' => true,'id'=>'special_allow']) !!} </td>
                                    <td> </td>
                                    <td> </td>
                                </tr>
                                <tr>
                                    <td> Bonus / Incentive</td>
                                    <td> {!! Form::text('bonus',0,['class' => 'form-control', 'data-required' => true,'id'=>'bonus']) !!} </td>
                                    <td> </td>
                                    <td> </td>
                                </tr>
                                <tr>
                                    <td> Arrear Salary</td>
                                    <td> {!! Form::text('arrear_salary',0,['class' => 'form-control', 'data-required' => true,'id'=>'arrear_salary']) !!} </td>
                                    <td> </td>
                                    <td> </td>
                                </tr>
                                <tr>
                                    <td> Advance Given</td>
                                    <td> {!! Form::text('advance_given',0,['class' => 'form-control', 'data-required' => true,'id'=>'advance_given']) !!} </td>
                                    <td> </td>
                                    <td> </td>
                                </tr>
                                <tr>
                                    <td> Leave Encashment</td>
                                    <td> {!! Form::text('leave_encashment',0,['class' => 'form-control', 'data-required' => true,'id'=>'leave_encashment']) !!} </td>
                                    <td> </td>
                                    <td> </td>
                                </tr>
                                <tr>
                                    <td> Total Earnings</td>
                                    <td> {!! Form::text('total_earning','7000',['class' => 'form-control', 'data-required' => true,'id'=>'total_earnings']) !!}</td>
