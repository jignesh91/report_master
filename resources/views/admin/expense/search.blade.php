        ...
        <form id="search-frm">
            <div class="row"> 
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" value="{{ \Request::get("search_title") }}" class="form-control" name="search_title" placeholder="Enter Title" />
                </div>
                <div class="col-md-4" style="padding: 0px;">
                     <label class="control-label">Amount</label>
                    <input type="text" value="{{ \Request::get("search_amount") }}" class="form-control" name="search_amount" placeholder="Enter Hours"/>
                </div>
            </div>
            <div class="row">        
