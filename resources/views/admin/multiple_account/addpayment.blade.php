                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                       ...
                                       {{ $member->middlename }}
                                        ...
                                        <input type="hidden" value="{{$bb_account_id}}" name="bb_account_id">
                                    </div>                                
                                    <div class="col-md-6">
                                        <label class="control-label">Installment Amount: <span class="required">*</span></label> 
                                        {!! Form::text('transaction_amount',null,['class' => 'form-control', 'data-required' => true,'placeholder' => 'Enter Installment Amount']) !!}
                                    </div>                                                 
                                </div>
