...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head>
        ...
        <link href="{{ asset("themes/admin/assets/")}}/layouts/layout3/css/custom.css" rel="stylesheet" type="text/css" />
    ...
    $(document).ready(function () {
            ...
            $("#search_start_leave").datepicker({
                ...
                showButtonPanel: false,
                onClose: function (selectedDate) {
                    $("#search_end_leave").datepicker("option", "minDate", selectedDate);
                }
            });

            $("#search_end_leave").datepicker({
                dateFormat: 'yy-mm-dd',
                changeYear: true,
                changeMonth: true,
                yearRange: '1900:2050',
                showButtonPanel: false,
                onClose: function (selectedDate) {
                    $("#search_start_leave").datepicker("option", "maxDate", selectedDate);
                }
            });
