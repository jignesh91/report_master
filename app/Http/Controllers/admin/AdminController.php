...
class AdminController extends Controller
{
    ...
    //Working Days
        ...
        //User Leave
			...
			$data['auth_user_month_leave'] = $user_month_leave;
			$data['auth_user_annual_leave'] = Custom::userannualleave($auth_user,$user_month_leave);

        //User Task
            $auth_user_hour = Task::AuthTaskHrs();
            $data['auth_user_hours'] = $auth_user_hour;
            
            $auth_user_month_hour = Task::AuthMonthlyHrs();
            $data['auth_user_month_hour'] = $auth_user_month_hour;

            $auth_user_today_hour = Task::AuthTodayHrs();
