...
class ClientMonthlyReportsController extends Controller
{
    public function __construct() {
    
        $this->moduleRouteText = "clients-reports";
        $this->moduleViewName = "admin.clients_reports";
    ...
    {
        $checkrights = \App\Models\Admin::checkPermission(\App\Models\Admin::$CLIENT_WISE_MONTHY_REPORT);
        ...
        $data = array();        
        $data['page_title'] = "Employee wise monthly hours by client";
    ...
    public function data(Request $request)
    {
        ...
        $model = Task::select(TBL_TASK.".*",TBL_CLIENT.".name as client_name",TBL_USERS.".name as user_name",TBL_PROJECT.".title as project_name",\DB::raw('SUM(total_time) as hours'))
